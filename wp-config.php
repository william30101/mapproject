 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'Ty[!AG#*_kv2Ca$Ls@+Ep/+oQAMS5g3r,x+|{&XeVa#1z-;w,;@BpLod;y+A^Cl(');
define('SECURE_AUTH_KEY',  'qz6&C;Hfi ^/PrIl1+r|(2sN6e[k-7*8H^P}wRYYsc<52bA=VX<0M]8T*p2?TvmX');
define('LOGGED_IN_KEY',    'X<k?[X-,zQ9,0d,qm`6(i3[0{oq+&I}}]D1*Dl=9Rl[>hqN^+qSg&kyYFn&-]F{U');
define('NONCE_KEY',        'x8l:R}$v@JZLV26lY9;l,Lo {?HUH]| A&!)YL$4gJ3V=/n{08iK0kl+,R%;R(|Q');
define('AUTH_SALT',        'CU(=dhc?!sUFn{u6!t(03i)[xIm&C0]S+-)j3C1|R?|-ib7~.S889+4LvnQwV~}g');
define('SECURE_AUTH_SALT', '+BF~XLdA8Lg AU+y&`-8->BPC4V<w7A:F+aS@9;5pEVMGK>3k67_~tB/Jt&^-DYf');
define('LOGGED_IN_SALT',   '|~,8-GED=<-*&E546FN[GKmUmo21I3;B`wU51yoyI5TPje$}o7-D!./j-(!~#Q|d');
define('NONCE_SALT',       'l4$z,gaA/x#Du3? %6 ,gtnx%AMNa%>?gj?[dJ?:<Q{FNYX`.+N*&-JR6%~uy&0-');
